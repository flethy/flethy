...
export namespace Covalent {
  export type Entity = { classA: any; classB: any; pricing: any }
  export type Endpoint =
    | { getTransactionsForAddress: ApiDescriptionEndpoint }
    | { getUniswapV3Pools: ApiDescriptionEndpoint }
    | { getHistoricalTokenPrices: ApiDescriptionEndpoint }
