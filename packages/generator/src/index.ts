...
import Clarifai from '../../connectors/src/configs/clarifai.config'
...
async function main() {
  const requestConfigs: {
    ...
    staticallyZap: nao<Statically.StaticZapGithub>({
      ...
      'param:repo': 'web3nao',
      'param:tag': 'main',
      'param:file': 'packages/connectors/package.json',
    }),
    ...
    mailchimpListCampaigns: nao<Mailchimp.ListCampaigns>({
      kind: 'mailchimp.campaigns.list',
      'subdomain:dc': 'us17',
      'auth:Authorization': { password: process.env.MAILCHIMP_API_KEY },
    }),
    incidentIoListIncidents: nao<IncidentIo.ListIncidents>({
...
Here you find all the available integrations`,
    ...
    twitterManagePostTweets: nao<Twitter.PostTweets>({
      ...
      'body:text': 'gmfrens 23',
      'body:media': {
        media_ids: ['1607749904285286401'],
      },
    }),
    twitterUploadMedia: nao<Twitter.UploadMedia>({
      ...
      'query:media_data': ``,
    }),
    cosmicjsProducts: nao<CosmicJS.GetProductsByMetadataValue>({
      kind: 'cosmicjs.products.byMetadataValue',
      'auth:read_key': process.env.COSMICJS_READ_KEY,
      'param:bucketSlug': process.env.COSMICJS_BUCKET_SLUG,
